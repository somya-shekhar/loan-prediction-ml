...
The project includes a FastAPI implementation for serving predictions. You can find more details in its [README.md file](https://github.com/SOMYASHEKHARLINKCHANGE/Loan-Predication/blob/main/packaging-ml--model/Loan_pred_Api/Readme.md).
